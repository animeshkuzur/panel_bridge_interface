...
<body>
  ...
  <nav class="navbar navbar-dark bg-dark">
	...
	<div class="config-panel">
		<div class="container">
			<div class="title">
				Fibaro Bridge <a href="{{ url('/sbus/').'/reload/1' }}" class="btn btn-outline-secondary">Reload</a> <a href="http://silop.in" target="_blank"><img src="{{ URL::asset('/assets/logo.png') }}" height="60" width="144" class="float-right"></a>
			</div>
			<hr>
      <div class="errors">
                  @if($errors)
